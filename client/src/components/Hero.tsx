...
export default function Hero() {
  return (
    <section id="home" className="pt-32 pb-20 md:pt-40 md:pb-32 px-6 bg-gradient-to-br from-light to-blue-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <div className="flex gap-6 mt-10 animate-fade-in animate-delay-500">
              <a href="#" className="text-gray-600 hover:text-primary transition-colors text-xl">
