        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-6">
              ...
              development began 3 years ago, and I've been hooked ever since.
            </p>
            <p className="text-gray-700 mb-6">
              I specialize in building responsive and user-friendly web
              applications using modern frameworks and technologies. I'm
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Global Institute of Engineering and Technology, 2026
                </p>
              </div>
              <div>
